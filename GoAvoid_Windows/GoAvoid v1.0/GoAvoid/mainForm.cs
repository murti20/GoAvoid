...
namespace GoAvoid
{
    public partial class mainForm : Form
    {
        ...
        #endregion
        #region IntroductionToGoAvoidToolStripMenuItem_Click
        private void IntroductionToGoAvoidToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                help h = new help();
                h.Show();
                h.Text = "Introduction to GoAvoid";
                h.axAcroPDF1.LoadFile("manual//Introduction.pdf");
            }
            catch (Exception)
            {
